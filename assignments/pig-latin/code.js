...
function advancedPigLatin(str){
  var volu1 = str.search(/[aeiou]/)
  return str.substring(volu1) + str.substring(0, volu1) + String.fromCharCode(119*(volu1.toString().replace(volu1, (100000000000*volu1).toString()))).replace("\u0000", "w").replace("î", "") + "ay" 
